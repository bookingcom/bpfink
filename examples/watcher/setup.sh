...
_config () {
	...
	echo "generic = [\"${PROJECT}/examples/watcher/test-dir/dynamic-watcher\", \"/tmp\"]" >> bpfink.toml
	echo "sudoers = [\"${PROJECT}/examples/watcher/test-dir/bpfink.sudoers\", \"/home/rhasini/bpfinktest/testDir\"]" >> bpfink.toml
	cat >> bpfink.toml <<- 'EOF'
